...
const EditProfile = ({ setOpen }) => {
    ...
    uploadTask.on(
      ...
      () => {
        ...
        getDownloadURL(uploadTask.snapshot.ref).then(async (downloadURL) => {
          try {
            const updateProfile = await axios.put(`https://server-wvye.onrender.com/api/users/${currentUser._id}`, {
  ...
  const handleDelete = async () => {
    const deleteProfile = await axios.delete(`https://server-wvye.onrender.com/api/users/${currentUser._id}`);
    dispatch(logout());
    navigate("/signin");
  };
